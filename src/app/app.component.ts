...
export class AppComponent {
  ...
  constructor(private service: CourseService) {
    ...
    this.columnDefList = service.GetColumnDefData(this.languageID);
  }
  public changeLanguage(_languageId: Languages) {
    this.languageID = _languageId;
    this.columnDefList = this.service.GetColumnDefData(this.languageID);
  }
